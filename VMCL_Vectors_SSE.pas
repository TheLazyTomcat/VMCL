...
asm
  ...
  {$DEFINE Normalize_4d3_SSE}{$INCLUDE 'VMCL_Vectors_SSE.inc'}{$UNDEF Normalize_4d3_SSE}
    ...
    MOVSD   qword ptr [Normal + 16], XMM1       //  [Normal + 16]:  n2
end;
...
asm
  ...
  {$DEFINE Normalize_4d3_SSE}{$INCLUDE 'VMCL_Vectors_SSE.inc'}{$UNDEF Normalize_4d3_SSE}
    ...
    MOVAPD  dqword ptr [Normal], XMM0           //       [Normal]:  n0  n1
    MOVAPD  dqword ptr [Normal + 16], XMM1      //  [Normal + 16]:  n2  00
end;
...
asm
  ...
  {$DEFINE Normalize_4d3_SSE}{$INCLUDE 'VMCL_Vectors_SSE.inc'}{$UNDEF Normalize_4d3_SSE}
    ...
    MOVUPD  dqword ptr [Normal], XMM0           //       [Normal]:  n0  n1
    MOVUPD  dqword ptr [Normal + 16], XMM1      //  [Normal + 16]:  n2  00
end;
...
asm
  ...
  {$DEFINE Negate_4d_SSE}{$INCLUDE 'VMCL_Vectors_SSE.inc'}{$UNDEF Negate_4d_SSE}
    ...
    MOVSD   qword ptr [Antinormal + 16], XMM1   //  [Antinormal + 16]: -n2
end;
...
asm
  ...
  {$DEFINE Negate_4d_SSE}{$INCLUDE 'VMCL_Vectors_SSE.inc'}{$UNDEF Negate_4d_SSE}
    ...
    MOVAPD  dqword ptr [Antinormal], XMM0       //       [Antinormal]: -n0  -n1
    MOVAPD  dqword ptr [Antinormal + 16], XMM1  //  [Antinormal + 16]: -n2   00
end;
...
asm
  ...
  {$DEFINE Negate_4d_SSE}{$INCLUDE 'VMCL_Vectors_SSE.inc'}{$UNDEF Negate_4d_SSE}
    ...
    MOVUPD  dqword ptr [Antinormal], XMM0       //       [Antinormal]: -n0  -n1
    MOVUPD  dqword ptr [Antinormal + 16], XMM1  //  [Antinormal + 16]: -n2   00
end;
...
asm
  ...
  {$ELSE}
    HADDPS    XMM1, XMM1                        //  XMM1: **  **  **  (b1v1 + b0v0)(BV_DP)
  ...
  {$ENDIF}
    ...
    MOVLPS    qword ptr [Projection], XMM3
    JMP       @RoutineEnd

  @Continue:

    DIVSS     XMM1, XMM2                        //  XMM2: **  **  **  (BV_DP / BB_DP)(D)
    SHUFPS    XMM1, XMM1, $00 {00000000}        //  XMM2: --  --  --  (BV_DP / BB_DP)(D)

    MULPS     XMM0, XMM1                        //  XMM2: 00  00  b1D   b0D

    MOVLPS    qword ptr [Projection], XMM0      //  [Projection]:   b0D   b1D
...
asm
    ...
    MOVAPS    XMM2, XMM0                        //  XMM2: b2  b1  00  b0

    MULPS     XMM1, XMM0                        //  XMM1: b2v2  b1v1   00   b0v0
    MULPS     XMM2, XMM2                        //  XMM2: b2b2  b1b1   00   b0b0
  ...
  {$IFDEF ASMDirectOPCodes}
    ...
    DB  $F2, $0F, $7C, $D2  //  HADDPS XMM2, XMM2
  {$ELSE}
    HADDPS    XMM1, XMM1                        //  XMM1: --  --  (b2v2 + b1v1)  (b0v0)
    HADDPS    XMM2, XMM2                        //  XMM2: --  --  (b2b2 + b1b1)  (b0b0)
    HADDPS    XMM1, XMM1                        //  XMM1: --  --  -- (b2v2 + b1v1 + b0v0)(BV_DP)
    HADDPS    XMM2, XMM2                        //  XMM2: --  --  -- (b2b2 + b1b1 + b0b0)(BB_DP)
  {$ENDIF}
    ...
    // BB dot product is zero, set projection to zero vector
    MOVSS     dword ptr [Projection], XMM3
    MOVHPS    qword ptr [Projection + 4], XMM3
    JMP       @RoutineEnd

  @Continue:

    // all four entries in XMM1 contains the same value
    DIVPS     XMM1, XMM2                        //  XMM2: --  --  --  (BV_DP / BB_DP)(D)

    MULPS     XMM0, XMM1                        //  XMM2: b2D   b1D    00   b0D

    MOVSS     dword ptr [Projection], XMM0      //  [Projection]:   b0D
    MOVHPS    qword ptr [Projection + 4], XMM0  //  [Projection]:   b0D   b1D   b2D
...
asm
    ...
    MULPS     XMM1, XMM0                        //  XMM1: b3v3  b2v2  b1v1  b0v0
  ...
  {$IFDEF ASMDirectOPCodes}
    ...
    DB  $F2, $0F, $7C, $D2  //  HADDPS XMM2, XMM2
  {$ELSE}
    HADDPS    XMM1, XMM1                        //  XMM1: --  --  (b3v3 + b2v2)  (b1v1 + b0v0)
    HADDPS    XMM2, XMM2                        //  XMM2: --  --  (b3b3 + b2b2)  (b1b1 + b0b0)
    HADDPS    XMM1, XMM1                        //  XMM1: --  --  -- (b3v3 + b2v2 + b1v1 + b0v0)(BV_DP)
    HADDPS    XMM2, XMM2                        //  XMM2: --  --  -- (b3v3 + b2b2 + b1b1 + b0b0)(BB_DP)
  {$ENDIF}
    ...
    // BB dot product is zero, set projection to zero vector
    MOVAPS    dqword ptr [Projection],  XMM3
    JMP       @RoutineEnd
  ...
  @Continue:
    ...
    MULPS     XMM0, XMM1                        //  XMM2: b3D   b2D   b1D   b0D

    MOVAPS    dqword ptr [Projection], XMM0     //  [Projection]:  b0D   b1D   b2D   b3D
...
asm
  ...
  {$ENDIF}
    ...
    // BB dot product is zero, set projection to zero vector
    MOVUPS    dqword ptr [Projection],  XMM3
    JMP       @RoutineEnd
  ...
  @Continue:
    ...
    MOVUPS    dqword ptr [Projection], XMM0     //  [Projection]:  b0D   b1D   b2D   b3D
...
asm
    ...
    MOVAPS    XMM2, XMM0                        //  XMM2: 00  b2  b1  b0

    MULPS     XMM1, XMM0                        //  XMM1: 00  b2v2  b1v1  b0v0
    MULPS     XMM2, XMM2                        //  XMM2: 00  b2b2  b1b1  b0b0
  ...
  @Continue:
    ...
    MULPS     XMM0, XMM1                        //  XMM2: 00  b2D   b1D   b0D

    MOVAPS    dqword ptr [Projection], XMM0     //  [Projection]:  b0D   b1D   b2D   00
    MOVSS     XMM1, dword ptr [Vector + 12]     //  XMM1: **  **  **  v3
    MOVSS     dword ptr [Projection + 12], XMM1 //  [Projection]:  b0D   b1D   b2D   v3
...
asm
  ...
  @Continue:
    ...
    MOVUPS    dqword ptr [Projection], XMM0     //  [Projection]:  b0D   b1D   b2D   00
    MOVSS     XMM1, dword ptr [Vector + 12]     //  XMM1: **  **  **  v3
    MOVSS     dword ptr [Projection + 12], XMM1 //  [Projection]:  b0D   b1D   b2D   v3
...
asm
  ...
  {$IFDEF ASMDirectOPCodes}
    ...
    DB  $66, $0F, $7C, $D2  //  HADDPD XMM2, XMM2
  {$ELSE}
    HADDPD    XMM1, XMM1                        //  XMM1: --  (v1b1 + v0b0)(BV_DP)
  ...
  @Continue:
    ...
    DIVPD     XMM1, XMM2                        //  XMM2: --  (BV_DP / BB_DP)(D)

    MULPD     XMM0, XMM1                        //  XMM2: b1D   b0D
